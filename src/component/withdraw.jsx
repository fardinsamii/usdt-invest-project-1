...
const Withdraw = () => {
  ...
  const handleBackClick = () => {
    navigate("/me"); // Navigates to the previous page in history
  };
            ...
            <div className="container p-4 container_box">
              ...
              <div className="balance-box text-start">
                ...
                <p className="balance-amount">
                  <strong>{data?.user?.withdraw_balance || 0}</strong> USDT
                </p>
              </div>
              <div className="withdrawal-method mb-4">
                <p className="mb-0">Withdrawal method:</p>
                <div className="method-usdt">
                  <Link to="/withdraw" className="btn active">
                    TRC20-USDT
                  </Link>
                  <Link to="/withdraw-trx" className="btn">
                    TRX
                  </Link>
                </div>
              </div>
